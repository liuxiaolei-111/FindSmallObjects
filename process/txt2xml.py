...
name_dict = {'0': 'ignored regions', '1': 'pedestrian', '2': 'people',
             ...
             '10': 'motor', '11': 'others'}
# name_dict = {'0': 'pedestrian', '1': 'people',
#              '2': 'bicycle', '3': 'car', '4': 'van', '5': 'truck',
#              '6': 'tricycle', '7': 'awning-tricycle', '8': 'bus',
#              '9': 'motor'}


def transfer_to_xml(pic, txt, file_name):
    xml_save_path = r'D:\UAV\VisDrone2019-DET-train\annotations_xml'  # 生成的xml文件存储的文件夹
...
if __name__ == '__main__':
    ...
    txt_folder = r'D:\UAV\VisDrone2019-DET-train\annotations'  # visdrone txt标签文件夹
    txt_file = os.listdir(txt_folder)
    img_folder = r'D:\UAV\VisDrone2019-DET-train\images'  # visdrone 照片所在文件夹
