...
#   指向了验证集标签与图片路径
# -------------------------------------------------------#
cocoGt_path = r'D:\UAV\VisDrone2019-DET-val\coco_annotations\UAV_val.json'
dataset_img_path = r'D:\UAV\VisDrone2019-DET-val\images_val_600'
# -------------------------------------------------------#
#   结果输出的文件夹，默认为map_out
# -------------------------------------------------------#
temp_save_path = r'map_out\coco_eval'
    ...
    if map_mode == 0 or map_mode == 1:
        ...
        with open(os.path.join(temp_save_path, 'eval_results.json'), "w") as f:
            ...
            for image_id in tqdm(ids):
                image_path = os.path.join(dataset_img_path, '{}.jpg'.format(image_id))
