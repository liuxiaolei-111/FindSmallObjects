...
def convert(xml_list, json_file):
    ...
    for index, line in enumerate(xml_list):
        ...
        # image_id = os.path.basename(xml_f)[:-4]
        image_id = addImgItem()
...
if __name__ == '__main__':
    # xml标注文件夹
    # ann_path = r"D:\UAV\VisDrone2019-DET-val\annotations_xml"
    xml_dir = r"D:\UAV\VisDrone2019-DET-val\annotations_xml"
    # 训练数据的josn文件
    save_json_val = r"D:\UAV\VisDrone2019-DET-val\coco_annotations\UAV_val_id_10.json"
    ...
    convert(xml_list, save_json_val)
    # 对验证数据集的xml进行coco转换
    # convert(xml_list_val, save_json_train)
