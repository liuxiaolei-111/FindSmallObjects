...
#   指向了验证集标签与图片路径
# -------------------------------------------------------#
cocoGt_path         = r'D:\UAV\VisDrone2019-DET-val\coco_annotations\UAV_val_ori_id.json'
dataset_img_path    = r'D:\UAV\VisDrone2019-DET-val\images'
# -------------------------------------------------------#
#   结果输出的文件夹，默认为map_out
# -------------------------------------------------------#
...
if __name__ == "__main__":
    ...
    if map_mode == 0 or map_mode == 1:
        yolo = mAP_YOLO(confidence=0.001, nms_iou=0.5)
